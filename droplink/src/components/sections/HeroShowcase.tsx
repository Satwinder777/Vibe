...
export function HeroShowcase() {
  return (
    <div className="relative mx-auto w-full max-w-md lg:max-w-none">
      ...
      <div className="absolute right-0 top-1/4 h-40 w-40 rounded-full bg-indigo-500/15 blur-[60px]" />

      <div className="relative space-y-4">
        {/* Upload card */}
        <motion.div
          animate={float(0)}
          className="showcase-card ml-0 mr-8 sm:mr-16"
        >
        ...
        <motion.div
          animate={float(0.6)}
          className="showcase-card ml-8 sm:ml-16 mr-0"
        >
        ...
        <motion.div
          animate={float(1.2)}
          className="showcase-card ml-4 mr-4"
        >
          <div className="flex items-center gap-3">
